...
class UploadHandler
{
    ...
    function __construct($options=null) {
        $this->options = array(
            ...
            'max_file_size' => null,
            'min_file_size' => 1,
            'accept_file_types' => '/(.jpg|.pdf|.jpeg|.png|.gif|.doc|.xls|.odt|.odf|.mp3|.mp4|.mov|.odd|.epub|.txt|.text|.rtf|.tif|.tiff|.csv|.svg|.docx|.mpg|.mpeg|.xml|.wmv|.zip|.rar|.xlsx|.xlsm|.flv|.avi)+$/i', //Here are the allowed file types.(case Insensitive) To add a news, just a |.filetype in the parenthesis
